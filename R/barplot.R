...
#' 
mybarplot <- structure(
  function # barplot with more flexibility on labels and axis
### barplot function allowing to set label and axis arguments, e.g. rotation of
### labels, giving a unit to the axis values
(
  height, 
  ### as in \code{\link{barplot}}
  names.arg = NULL, 
  ### as in \code{\link{barplot}}
  ...
  args.text = NULL, 
  ### list of arguments that are given to \code{text} being called to plot the
  ### bar group labels. Use \code{\link{args_text}} to create such a list.
  args.yaxis = NULL
  ### list of arguments that are given to \code{axis} being called to plot the
  ### y axis. Use \code{\link{args_yaxis}} to create such a list.
)
{
...
#'   y axis. Use \code{\link{args_yaxis}} to create such a list.
#' 
args_mybarplot <- function # Create argument list for mybarplot
### Create argument list for mybarplot
(
  cex.axis = graphics::par("cex.axis"),
  ### character expansion factor of axis labels
...
#'   \code{\link{mybarplot}}
#' 
args_text <- function # Create argument list for text
### Create argument list for text
(
...
)
{
  ...
  ### list of arguments that may be used as \code{args.text} in
  ### \code{\link{mybarplot}}
}
...
#'   \code{\link{mybarplot}} 
#' 
args_yaxis <- function # Create argument list for axis
### Create argument list for axis
(
...
)
{
  ...
  ### list of arguments that may be used as \code{args.yasis} in
  ### \code{\link{mybarplot}} 
}
