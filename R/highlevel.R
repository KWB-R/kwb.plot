...
#' 
plotRain <- function # plot rain data as bars
### plot rain data as bars
(
  timestamps, 
  ### timestamps 
  ...
  ### y limits
  signal.width = NA, 
  ### width of time intervals represented by timestamps, in seconds. If NA 
  ### (default) this value is deduced from the time differences in 
  ### \emph{timestamps}
  shift.to.begin = 0, 
  ### value in seconds by which the timstamps need to be shifted in order to get
  ### the begin of the time intervals that the timestamps represent. Default: 0
  ### (meaning that the timestamps represent the beginnings of the time 
  ### intervals). A value of \emph{signal.width} would mean that the timestamps
  ### represent the ends of the time intervals and a value of 
  ...
  pch = 16,
  ### plot character to be used for plotting data points (at the given
  ### timestamps), additionally to plotting bars. Set to NA in order to suppress
  ### plotting these points
  reverse.ylim = TRUE, 
  ### if TRUE (default), the y axis is reversed, i.e. the bars are heading from
  ### top to bottom
  las = 1,
...
#'   top to bottom  
#' 
plot_variable <- function # plot_variable
### plot_variable
(
  hydraulicData, 
  ### data frame with at least two columns. First column is expected to contain
  ### the timestamps
  ...
  absolute = FALSE,
  ### if TRUE, innerMargins are to be interpreted as absolute values instead of 
  ### fractions of the plot region. Default: FALSE
  reverse.ylim = FALSE, 
  ### if TRUE (default), the y axis is reversed, i.e. the bars are heading from
  ### top to bottom  
